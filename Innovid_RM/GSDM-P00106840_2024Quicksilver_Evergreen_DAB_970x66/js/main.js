...
function expand(){
  ...
  cardTL.from('.card-inner', 1,{rotationY:"-180", rotationX:"90", ease:'power2.inOut'}, _f1)
        .from('.shadow-inner', 1.1,{alpha:0, transformOrigin:"top center", scaleX:0.7, rotationY:"+=45", y:"-=20", ease:'power3.inOut'}, '<')
        ...
        .fromTo('.card-shadow', {rotationY:"-=15", duration:swaySpeed, yoyo:true, repeat:4, ease:'power1.inOut'}, {rotationY:"+=30", duration:swaySpeed, yoyo:true, repeat:4, ease:'power1.inOut'}, '<')
